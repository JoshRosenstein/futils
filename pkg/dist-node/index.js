...
const allPass_ = (fns, ...args) => reduceWhile_(acc => acc === true, (_, fn) => fn(...args), true, toArray(fns));
...
const anyPass_ = (fns, ...args) => reduceWhile_(acc => acc === false, (_, fn) => fn(...args), false, toArray(fns));

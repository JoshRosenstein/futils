...
export const flattenTree_ = (delimiter, recordTree) => reduce_((accumulated, [keys, value]) => merge_(accumulated, { [join_(delimiter, keys)]: value }), {}, flattenTreeDelimiterMapping(recordTree));

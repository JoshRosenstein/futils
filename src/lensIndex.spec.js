...
describe('lensIndex', () => {
  ...
  describe('well behaved lens', () => {
    ...
    test('get (set s v) === v', () => {
      ...
      expect(view(lensIndex(0), set(lensIndex(0),0, testList), testList)).toEqual(0)
    })

    test('get (set(set s v1) v2) === v2', () => {

      expect(view(lensIndex(0), set(lensIndex(0),11,  set(lensIndex(0), 10, testList)))).toEqual(11)
    })
